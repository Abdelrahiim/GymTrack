...
export function WorkoutForm({ initialData }: WorkoutFormProps) {
  ...
  const form = useForm<WorkoutFormValues>({
    ...
    defaultValues: initialData
      ...
      : {
          ...
          name: "",
          exercises: [{ name: "", sets: [{ reps: undefined, weight: undefined, weightUnit: WeightUnit.KG }] }],
        },
    mode: "onChange",
  });

  const { fields: exerciseFields, append: appendExercise, remove: removeExercise } = useFieldArray<WorkoutFormValues, "exercises", "fieldId">({
  ...
  const handleAppendExercise = () => {
    appendExercise({ name: "", sets: [{ reps: undefined, weight: undefined, weightUnit: WeightUnit.KG }] });
  };
      ...
      const workoutPayload: WorkoutPayload = {
        ...
        exercises: data.exercises.map((ex) => ({
          ...
          sets: ex.sets.map((set) => ({
            ...
            weightUnit: set.weightUnit || WeightUnit.KG,
          })),
        })),
      };
