          ...
          <div className="ml-3 relative hidden md:block">
            {session ? (
              <div className="flex items-center">
                <span className="mr-3 text-sm font-medium">{session.user.name}</span>
                <div className="relative">
                  <button
                    type="button"
                    className="flex text-sm rounded-full ring-2 ring-white focus:outline-none focus:ring-offset-2 focus:ring-offset-indigo-600 focus:ring-white"
